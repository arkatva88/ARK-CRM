...
export default function CreateQuotationPage() {
  ...
  const [quotationNumber, setQuotationNumber] = useState(generateDocNumber('QUO'));
  ...
  const fetchData = async () => {
    ...
    // Default expiry date: 15 days from today
    const exp = new Date();
    ...
    <div>
      <div className="header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div className="page-title">Create New Quotation</div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid-2">
          <div className="card" style={{ padding: '1.5rem' }}>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                className="form-control"
                rows={3}
                placeholder="Scope of work, deliverables, payment terms..."
              />
            </div>
          </div>
          ...
          <div className="card" style={{ padding: '1.5rem' }}>
            ...
            <div className="grid-1-1">
              ...
              <div className="form-group">
                <label className="form-label">Valid Until (Expiry Date)</label>
                <input
                  type="date"
                  value={expiryDate}
        ...
        <div className="card" style={{ marginBottom: '2rem' }}>
          <div className="card-header">
            <h3 style={{ fontSize: '1rem', fontWeight: 600 }}>Quotation Items & Services</h3>
          ...
          >
            <div style={{ textAlign: 'right' }}>
              <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>Estimated Grand Total:</div>
